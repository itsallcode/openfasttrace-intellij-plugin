...
Use basic completion while editing a Markdown declaration ID field or a `Covers:` entry to select an existing specification item ID from the project index.
