...
final class OftCoverageTagTraceItemNavigator {
    private static final Logger LOG = Logger.getInstance(OftCoverageTagTraceItemNavigator.class);

    private final Project project;

    OftCoverageTagTraceItemNavigator(final Project project) {
